...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="card col-12  col-md-9 shadow-sm p-0">
            <div class="card-header ">مقاله</div>
                ...
                <form action="adminBlog.php" method="post" enctype="multipart/form-data">
                    <ul class="list-group-flush ps-0">
                        <li class="list-group-item">
                            تصویر شاخص مقاله:
                            <input type="file" name="blogImg" class="form-control mt-1">
                        </li>

                        <li class="list-group-item">
                            عنوان مقاله
                            <input type="text" name="blogName" class="form-control mt-1">
                        </li>


                        <li class="list-group-item float-left">
                            <input type="submit" class="btn btn-success mt-1 float-left" name="addBlog" value="افزودن نام و تصویر شاخص مقاله جدید">
                        </li>
                </form>
            </div>
