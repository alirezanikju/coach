    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="card col-12  col-md-9 shadow-sm p-0">
                <div class="card-header ">سرویس ها</div>
                    ...
                    <form action="adminService.php" method="post">
                        <ul class="list-group-flush ps-0">
                            ...
                            <li class="list-group-item">
                                عنوان سرویس:
                                <input type="text" name="serviceTitle" class="form-control mt-1">
                            </li>

                            <li class="list-group-item">
                                توضیح:
                            <textarea class="form-control mt-1" name="aboutService" rows="5" cols="20">
                                        </textarea>
                            </li>

                            <li class="list-group-item float-left">
                                <input type="submit" class="btn btn-success mt-1 float-left" name="addService" value="افزودن ">
                            </li>
                    </form>
                </div>
                ...
                <div class="row m-3">
                    <?php foreach ($service as $item) { ?>
                        ...
                        <div class="col-6 card">
                            <div class="card-body">
                                <p>عنوان : <?php echo $item['serviceTitle'];  ?></p>
                                <p>توضیح  : <?php echo $item['aboutService']; ?></p>
                                <a href="?deleteServiceId=<?php echo $item['id']; ?>" class="btn btn-danger w-100">حذف سرویس</a>
                            </div>
                        </div>
