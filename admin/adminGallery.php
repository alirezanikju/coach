    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="card col-12  col-md-9 shadow-sm p-0">
                <div class="card-header ">گالری</div>

                <div class="">
                    <form action="adminGallery.php" method="post" enctype="multipart/form-data">
                        <ul class="list-group-flush ps-0">
                            <li class="list-group-item">
                                تصویر مورد نظر:
                                <input type="file" name="galleryPhoto" class="form-control mt-1">
                            </li>

                            <li class="list-group-item float-left">
                                <input type="submit" class="btn btn-success mt-1 float-left" name="addgallery" value="افزودن ">
                            </li>
                    </form>
                </div>
                ...
                <div class="row m-3">
                    <?php foreach ($gallery as $galleryPhoto) { ?>
                        ...
                        <div class="col-6 card">
                            <div class="card-body">
                                <img src="galleryImg/<?php echo $galleryPhoto['galleryImg']; ?>" class="card-img-top">
                                <a href="?deletegalleryId=<?php echo $galleryPhoto['id']; ?>" class="btn btn-danger w-100">حذف </a>
                            </div>
                        </div>
